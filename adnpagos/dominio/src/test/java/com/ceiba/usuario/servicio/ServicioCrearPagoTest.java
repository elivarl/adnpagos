...
public class ServicioCrearPagoTest {
	...
	void crearPagoDiaSabado() {
		...
		ServicioCrearPago servicioCrearPago = new ServicioCrearPago(repositorioPago, daoServicio, repositorioServicioElectrico, reglaPago);
	...
	void aplicarReglaNegocioDiezDiasAntes() {
		...
		ServicioElectrico servicioElectrico = new ServicioElectrico(1L, "1", "1717213183", "Elivar Oswaldo Largo", "Abril", LocalDateTime.parse("2022-03-18T15:00:00.104"), 90.00, false, null);
		...
		detalleTestDataBuilders.add(new PagoDetalleTestDataBuilder().conIdServicio(1L).conValor(servicioElectrico.getValor()));
		
		String porcentajeDescuento="8";
		Double valorDescuento=7.2;
				
		PagoTestDataBuilder pagoTestDataBuilder = new PagoTestDataBuilder().conFechaPago(diaPagoNormal).conPagoDetalles(detalleTestDataBuilders);
	...
	void aplicarReglaNegocioTresDiasAntes() {
		...
		ServicioElectrico servicioElectrico = new ServicioElectrico(1L, "1", "1717213183", "Elivar Oswaldo Largo", "Abril", LocalDateTime.parse("2022-03-04T15:00:00.104"), 90.00, false, null);
	...
	void aplicarReglaNegocioPagosMayoresFechaPago() {
		...
		ServicioElectrico servicioElectrico = new ServicioElectrico(1L, "1", "1717213183", "Elivar Oswaldo Largo", "Abril", LocalDateTime.parse("2022-03-24T15:00:00.104"), 90.00, false, null);
